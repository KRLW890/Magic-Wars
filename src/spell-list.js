...
var initSpells = function() {
    spells = [
        ...
        new Spell("Erratic", 1, 5, 5, new Stats("?", "?", "?", "?"), true),
        new Spell("Blaze", 2, 5, 8, new Stats(1.15, 0.9, 0.9, 1)),
        new Spell("Sustain", 3, Infinity, 15, new Stats()),
        new Spell("Health Boost", 4, 2, 15, new Stats(), true),
        ...
        new Spell("Lockdown", 8, Infinity, 15, new Stats()),
        ...
        new Spell("Regeneration", 22, 4, 15, new Stats()),
        new Spell("Boil", 23, 3, 20, new Stats(2, 0.8, 1.4, 0.7)),
        ...
        new Spell("Glass Edge", 29, 3, 13, new Stats("?", 1, 0.6, 0.8)),
        new Spell("Decay", 30, Infinity, 15, new Stats(1, 1, 1, 1)),
